...
stop_iteration = 1000000000  # stop time in terms of iteration count
...
analysis_tasks = initialize_output(solver, data_dir, Lx, Lz, plot_boundaries=False, threeD=False, mode="overwrite", slice_output_dt=40, output_dt=40, out_iter=100) #need to change this when i make output file
